...
const Font* World::font() const { return style()->font(); }
const Color* World::foreground() const { return style()->foreground(); }
const Color* World::background() const { return style()->background(); }
